...
// Class(클래스): 공통된 속성과 기능을 하나로 정의해둔 것
// [접근제어자] class 클래스명 { 속성, 기능 }
// 접근제어자: public, private, protected, default가 있음
...
class ExampleClass1 {
	...
	// 클래스변수(static 변수, 정적변수)
	// 해당 클래스로 생성된 모든 인스턴스가 공유하는 변수
	// 속성 앞에 static 키워드를 사용하여 지정할수 있음
	...
	// 매개변수: X, 반환값: X
	void method4 () {
		//  (인스턴스 변수, 메서드)는 (스테틱 변수, 메서드)를 사용할수 있음
	...
	static void staticMethod() {
		// (스테틱 변수, 메서드)에서는 (인스턴스 변수, 메서드)를 사용할수 없음
...
//		this(attribute1, -99.99); this 이렇게도 사용 가능 하지만 잘 사용x
		this();
		this.attribute1 = attribute1;
		this.attribute2 = -99.99;
	}
