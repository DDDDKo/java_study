...
// 에러와의 차이 에러가 발생하면 프로그램이 실행조차 되지 않지만, 예외는 실행은 됨
...
public class A_Exception {
	...
	private void thrwoException() throws Exception{
	...
	public static void main(String[] args) {
		...
		try {
			...
			// finally 로 예외가 발생하든 안 하든 실행할 코드를 작성
			// 자원의 반환 처리를 대부분 finally 에서 작업  -> 가독성과 처리를 쉽게 하기 위해 사용
			scanner.close();
